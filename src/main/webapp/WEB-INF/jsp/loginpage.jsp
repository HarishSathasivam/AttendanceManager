...
<body style="width:100%;height:100%;background-image: url('image/nusyn_bg_tile.png?<%= NusynConstants.imageVersion %>')">
	...
	<form id="loginForm" name="loginForm" method="POST"	action="validateUser.htm">
		<div align="center" style="width:100%;height:100%">
			...
			<div style="position:relative;top:100px;width:671px;height:374px;background-image: url('/AttendanceManager/image/nusyn_login_ui_bg.png?<%= NusynConstants.imageVersion %>')">
				<input id="input_username" class="input_field_1" style="position:absolute;top:87px;left:35px;" type="text" id="username" name="username" placeholder="Username">
				...
				<button id="Btn_login" type="submit" class="Btn_login" style="position:absolute;left:296px;top:157px;"><span class="button_label_1">LOGIN</span></button>
