...
<script type="text/javascript">
	...
	function homeLandingPage()
	{
		...
		formToSubmit.attr("action", "homelandingpage.htm");
		formToSubmit.submit();
	}
	function logout()
	{
...
<body style=" top:100px; position :absolute;width:100%;height:100%;background-image: url('image/nusyn_bg_tile.png?<%= NusynConstants.imageVersion %>' )">
	<div id="Top_Menu_Container" class="Top_Menu_Container" style="position:relative ; top:-100px; width:100%; height:100px;background-image: url('image/metro_topcontainer_bg_tile.png?<%= NusynConstants.imageVersion %>');">
		...
		<span id="Top_Menu_Product_Name" class="Top_Menu_Product_Name" style ="position:relative;left:35px; color: #bac1c4;">NusynLicenseManager / Setup<br></span>
		<form id="mainForm" name="mainForm" method="POST" action="">
		</form>
		<button id="back_button" name="button" value="OK" type="button" onclick="homeLandingPage()" style="padding:5px;top:60px; left:20px;position :absolute;">BACK</button>
